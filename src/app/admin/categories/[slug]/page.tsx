...
export default function AdminCategoryEditPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (loading) {
    return <div className="p-8 text-center text-surface-500 dark:text-surface-400">Loading category details...</div>;
  }
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <h1 className="text-3xl font-bold text-surface-900 dark:text-surface-100">Edit Category</h1>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full py-2.5 px-3 rounded-lg border border-surface-200 dark:border-surface-800 bg-white dark:bg-surface-900 text-surface-900 dark:text-surface-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                >
          ...
          <Card className="bg-white dark:bg-surface-900 border-surface-200 dark:border-surface-800 p-6">
            ...
            {attributes.length > 0 ? (
              ...
              <p className="text-sm text-surface-500 dark:text-surface-400 italic">No custom attributes defined.</p>
            )}
          </Card>
        </div>
            ...
            <div className="space-y-4 mb-6">
              <label className="flex items-center gap-3 text-sm font-medium text-surface-900 dark:text-surface-200 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 rounded border-surface-300 dark:border-surface-700 dark:bg-surface-800 text-brand-600 focus:ring-brand-500"
                />
